...
const DoughRecipeList = () => {
  const { doughRecipes, doughRecipesMap, ingredientsMap, loading, refreshData, fillingRecipes } = useContext(DataContext);
  ...
  const handleConfirmDelete = async () => {
    try {
      const response = await fetch(`/api/dough-recipes/${deleteConfirm.id}`, { method: 'DELETE' });
